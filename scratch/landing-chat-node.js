...
const t = {
  es: {
    ...
    responseTime: 'Suelen responder en menos de 24 horas y ofrecen diagnóstico gratuito.',
    ...
    whatsappInfo: 'Sí, trabajan con automatización de WhatsApp y atención al cliente.',
    appointmentsInfo: 'Sí, trabajan con turnos, reservas, recordatorios y orden de agenda, algo muy útil para clínicas, barberías, peluquerías, spas y negocios similares.',
    erpCrmInfo: 'Sí, desarrollan ERP, CRM, sistemas de gestión, paneles administrativos y software a medida.',
    integrationsInfo: 'Sí, integran herramientas para que la información fluya entre CRM, ERP, formularios, pagos y otros procesos.',
    collectionsInfo: 'Sí, también se pueden automatizar cobros, recordatorios, reservas y documentos.',
    reportsInfo: 'Sí, también desarrollan reportes, dashboards, KPIs y paneles para tener más visibilidad del negocio.',
    aiInfo: 'Sí, trabajan con agentes de IA y automatizaciones inteligentes, pero no siempre hace falta IA: depende del proceso.',
  ...
  en: {
    ...
    responseTime: 'They usually reply in under 24 hours and offer a free diagnosis.',
    ...
    whatsappInfo: 'Yes, they work with WhatsApp automation and customer service.',
    appointmentsInfo: 'Yes, they work with appointments, bookings, reminders, and schedule organization, which is especially useful for clinics, barbershops, hair salons, spas, and similar businesses.',
    erpCrmInfo: 'Yes, they build ERP, CRM, management systems, admin panels, and custom software.',
    integrationsInfo: 'Yes, they connect tools so information can flow between CRM, ERP, forms, payments, and other processes.',
    collectionsInfo: 'Yes, collections, reminders, bookings, and documents can also be automated.',
    reportsInfo: 'Yes, they also build reports, dashboards, KPIs, and panels to give you more visibility over the business.',
    aiInfo: 'Yes, they work with AI agents and smart automations, but AI is not always necessary. It depends on the process.',
  ...
  pt: {
    ...
    responseTime: 'Eles costumam responder em menos de 24 horas e oferecem diagnóstico gratuito.',
    ...
    whatsappInfo: 'Sim, eles trabalham com automação de WhatsApp e atendimento ao cliente.',
    appointmentsInfo: 'Sim, eles trabalham com agendamentos, reservas, lembretes e organização de agenda, algo muito útil para clínicas, barbearias, salões, spas e negócios parecidos.',
    erpCrmInfo: 'Sim, eles desenvolvem ERP, CRM, sistemas de gestão, painéis administrativos e software sob medida.',
    integrationsInfo: 'Sim, eles integram ferramentas para que os dados circulem entre CRM, ERP, formulários, pagamentos e outros processos.',
    collectionsInfo: 'Sim, cobranças, lembretes, reservas e documentos também podem ser automatizados.',
    reportsInfo: 'Sim, eles também fazem relatórios, dashboards, KPIs e painéis para dar mais visibilidade ao negócio.',
    aiInfo: 'Sim, eles trabalham com agentes de IA e automações inteligentes, mas IA nem sempre é necessária. Isso depende do processo.',
...
const problemCode = findCode({
  ...
  mixed_appointments: ['se me mezclan los turnos', 'se mezclan los turnos', 'appointments get mixed up', 'booking mess', 'agendamentos baguncados', 'agendamentos bagunçados', 'turnos desordenados'],
...
const directIntentMatches = {
  ...
  technical_knowledge: ['no entiendo de tecnologia', 'no entiendo de tecnología', 'no entiendo de sistemas', 'conocimientos tecnicos', 'conocimientos técnicos', 'es complicado usarlo', 'do i need technical knowledge', 'i dont understand tech', 'i do not understand tech', 'is it hard to use', 'preciso saber de tecnologia', 'preciso saber de tecnologia', 'nao entendo de sistemas', 'não entendo de sistemas', 'é dificil de usar', 'é difícil de usar'],
