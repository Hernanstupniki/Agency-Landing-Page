...
export function Differentiator({ language }: DifferentiatorProps) {
  ...
  return (
    <>
      <section id="como-trabajamos" className="section-dark-shell section-format-rings py-14 sm:py-20" data-animate="section">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="card-premium relative overflow-hidden rounded-3xl px-6 py-16 sm:px-12 sm:py-20 lg:px-16" data-animate="card">
            <div className="absolute inset-0 -z-10">
              <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(15,31,61,0.08)_1px,transparent_1px),linear-gradient(to_bottom,rgba(38,38,220,0.13)_1px,transparent_1px)] bg-[size:4rem_4rem]" />
            </div>

            <div className="mx-auto max-w-3xl text-center">
              <div className="mx-auto mb-8 flex h-16 w-16 items-center justify-center rounded-2xl border border-[#0f1f3d]/20 bg-gradient-to-br from-[#1e2d7f] to-[#2626dc] text-[#75f0e6]">
              ...
              <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
                <button
                  ...
                  className="btn-premium pressable-control inline-flex items-center gap-2 rounded-full border border-[#0b1830]/10 bg-gradient-to-r from-[#18d7d1] to-[#249bff] px-6 py-3 text-sm font-semibold text-white transition-colors hover:from-[#16c9c3] hover:to-[#228fed]"
                >
